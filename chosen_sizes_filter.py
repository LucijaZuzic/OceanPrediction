...
if not os.path.isdir("chosen_sizes_filter"):
    os.makedirs("chosen_sizes_filter")
...
for model_name in model_names:
    ...
    plt.savefig("chosen_sizes_filter/ws_hidden_" + model_name + ".png", bbox_inches = "tight")
    plt.close()
    ...
    for ws in filtered_best_hidden_for_model_ws:
        ...
        plt.savefig("chosen_sizes_filter/ws_" + str(ws) + "_" + model_name + ".png", bbox_inches = "tight")
        plt.close()
    ...
    for hidden in filtered_best_ws_for_model_hidden:
        ...
        plt.savefig("chosen_sizes_filter/hidden_" + str(hidden) + "_" + model_name + ".png", bbox_inches = "tight")
        plt.close()