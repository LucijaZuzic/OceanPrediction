...
for filename_no_csv in os.listdir("train_net"):  
    ...
    for model_name in os.listdir("train_net/" + filename_no_csv + "/predictions/test"):
        ...
        if os.path.isfile("final_train_net/" + filename_no_csv + "/predictions/train/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_hidden_" + str(hidden) + "_train.csv"):
            print("Skipping")
            continue
