...
all_subdirs = os.listdir("../InflectionPoints")

for subdir_name in all_subdirs:
        
    if not os.path.isdir("../InflectionPoints/" + subdir_name) or "Vehicle" not in subdir_name:
        continue 
    print(subdir_name)
    
    all_files = os.listdir("../InflectionPoints/" + subdir_name + "/cleaned_csv/") 
    ...
    for some_file in all_files:   
        ...
        file_with_ride = pd.read_csv("../InflectionPoints/" + subdir_name + "/cleaned_csv/" + some_file)
