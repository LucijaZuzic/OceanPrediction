...
for filename_no_csv in os.listdir("train_net"):  
    ...
    for model_name in os.listdir("train_net/" + filename_no_csv + "/predictions/test"):  
        ...
        if not os.path.isdir("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name):
            os.makedirs("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name) 
        ...
        for ws in ws_range: 
            ...
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xticks(hidden_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE_training_validation.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xticks(hidden_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE_training_testing.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xticks(hidden_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE_validation_testing.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xlabel("Broj skrivenih jedinica")
            plt.ylabel("Normalizirani RMSE") 
            plt.plot(hidden_range, train_RMSE_filtered_ws) 
            plt.xticks(hidden_range) 
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE_training_only.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xlabel("Broj skrivenih jedinica")
            plt.ylabel("Normalizirani RMSE") 
            plt.plot(hidden_range, val_RMSE_filtered_ws) 
            plt.xticks(hidden_range) 
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE_validation_only.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xlabel("Broj skrivenih jedinica")
            plt.ylabel("Normalizirani RMSE") 
            plt.plot(hidden_range, test_RMSE_filtered_ws) 
            plt.xticks(hidden_range) 
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_ws_" + str(ws) + "_RMSE_test_only.png", bbox_inches = "tight")
            plt.close()
        ...
        for hidden in hidden_range:
            ...
            plt.xticks(ws_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xticks(ws_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE_training_validation.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xticks(ws_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE_training_testing.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xticks(ws_range)
            plt.legend()
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE_validation_testing.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xlabel("Veličina prozora")
            plt.ylabel("Normalizirani RMSE") 
            plt.plot(ws_range, train_RMSE_filtered_hidden) 
            plt.xticks(ws_range)
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE_training_only.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xlabel("Veličina prozora")
            plt.ylabel("Normalizirani RMSE") 
            plt.plot(ws_range, val_RMSE_filtered_hidden) 
            plt.xticks(ws_range)
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE_validation_only.png", bbox_inches = "tight")
            plt.close()
            ...
            plt.xlabel("Veličina prozora")
            plt.ylabel("Normalizirani RMSE") 
            plt.plot(ws_range, test_RMSE_filtered_hidden) 
            plt.xticks(ws_range)
            plt.savefig("train_net/" + filename_no_csv + "/RMSE_plots_filtered/" + model_name + "/" + filename_no_csv + "_" + model_name + "_hidden_" + str(hidden) + "_RMSE_testing_only.png", bbox_inches = "tight")
            plt.close()